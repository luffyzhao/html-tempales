...
<p><?php echo APP_NAME; ?> is a fully responsive html template, perfect for anyone
...
<p>Trough this documentation we have laid out information about using
	<?php echo APP_NAME; ?> and in-depth customizing of elements in the item.</p>

<h3>Getting started</h3>
<hr class="separator bottom" />
<p>
	Find your way around <?php echo APP_NAME; ?> with it's available theme &amp; layout
...
<p>A complete showcase of each element and editable components is shown
	...
	the best and fastest workflow when editing <?php echo APP_NAME; ?>. <a href="<?php echo getURL(array('page' => 'documentation', 'section' => 'customization-guide', 'ss' => 'grid-system')); ?>" class="glyphicons single share"><i></i>Customization Guide</a></p>
