<p><?php echo APP_NAME; ?> is multilingual &amp; ready for your language, whatever
...
<p>Then, using PHP it's really simple to get that value in any page of <?php echo APP_NAME; ?> and display it to the user:</p>
