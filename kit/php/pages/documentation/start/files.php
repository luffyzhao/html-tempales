...
<p><?php echo APP_NAME; ?> is released in 2 versions:</p>
<ul>
...
<p>However, if you don't have much experience with scripting languages like PHP or never used a framework like Zend or Cake PHP, <?php echo APP_NAME; ?>'s PHP version offers a good base, yet simple for starting your implementation, with examples of a minimal structure, file templating - header, pages, footer - reusable functions, etc.</p>
...
/ 						// Root Directory
&lt;php|html&gt;/					// <?php echo APP_NAME; ?> HTML/PHP versions
...
<h3>CSS Files</h3>
<hr class="separator bottom" />
<p><?php echo APP_NAME; ?> uses couple of stylesheets to control visual apperance. There are stylesheets from Twitter Bootstrap, default theme stylesheets, skin stylesheets, and plugin stylesheets.</p>
...
<hr class="separator bottom" />
<p>
	<?php echo APP_NAME; ?> uses many 3rd party plugins &amp; scripts, as well as custom
