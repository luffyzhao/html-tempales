...
<div class="row-fluid">
	<div class="span4">
		...
		<hr class="separator bottom" />
		<a href="<?php echo getURL(); ?>theme/images/docs/mobile-responsive-tables-regular.PNG" target="_blank" class="thumb" style="padding: 5px; margin: 0 0 10px;"><img src="<?php echo getURL(); ?>theme/images/docs/mobile-responsive-tables-regular.PNG" /></a>
	...
	<div class="span4">
		...
		<hr class="separator bottom" />
		<a href="<?php echo getURL(); ?>theme/images/docs/mobile-responsive-tables-horizontal-swipe.PNG" target="_blank" class="thumb" style="padding: 5px; margin: 0 0 10px;"><img src="<?php echo getURL(); ?>theme/images/docs/mobile-responsive-tables-horizontal-swipe.PNG" /></a>
	...
	<div class="span4">
		...
		<hr class="separator bottom" />
		<a href="<?php echo getURL(); ?>theme/images/docs/mobile-responsive-tables-block.PNG" target="_blank" class="thumb" style="padding: 5px; margin: 0 0 10px;"><img src="theme/images/docs/mobile-responsive-tables-block.PNG" /></a>
